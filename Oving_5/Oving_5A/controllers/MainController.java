...
import model.AddressBookFileHandler;
import model.ContactDetails;
import views.ContactDetailsDialog;
import views.ContactsApp;
...
public class MainController {
     ...
     */
    public void editContact(AddressBook addressBook, ContactDetails selectedContact, ContactsApp parent) {
        if (selectedContact == null) {
            showPleaseSelectItemDialog();
        } else {
            ContactDetailsDialog contactDialog = new ContactDetailsDialog(selectedContact, true);
            contactDialog.showAndWait().ifPresent(addressBook::addContact);
